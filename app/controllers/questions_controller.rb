class QuestionsController < ApplicationController
  ...
  def get_questionList_by_paperId
    @questions = Question.select(:id,:title,:title_url, :title_url_show_type, :position,:questionA,:questionB,:questionC,:questionD,:questionE,:questionF, :answer, :analysis, :analysis_url, :analysis_url_show_type, :question_type).select(get_question_file_attr).where(:active => true, :paper_id => params[:paperId])
    @questions.each{
      |question|       
